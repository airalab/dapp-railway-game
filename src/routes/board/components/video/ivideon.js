...
const Main = () => (
  <div className="iv-embed" style={{ margin: '0 auto', padding: 0, border: 0, width: 853 }}>
    <div className="iv-v" style={{ display: 'block', margin: 0, padding: 1, border: 0, background: '#000' }}>
      <iframe className="iv-i" style={{ display: 'block', margin: 0, padding: 0, border: 0 }} src="https://open.ivideon.com/embed/v2/?server=100-EBBc8x5nYs9oYyXO8E4wkt&amp;camera=0&amp;width=&amp;height=&amp;lang=ru" width="853" height="480" frameborder="0" allowfullscreen />
    </div>
